...
export const PROJECTS_LIST = [
    ...
    },
    {
        ...
        wil                 :"One of the first simple projects I developed to put my first pygame knowledge into practice. My wish from the beginning was to mirror the behaviour of real world physics within the program."
    },
    {
        name                : "Calc It" ,
        repoLink            : "https://github.com/PySanti/calc-it.git",
        videoFileName       : "./projectVideos/ci.mp4",
        wil                 : "I developed this project shortly after I started learning React, it doesn't have the best implementation and use of React, and now I look at the code and realise how much I've learned since then."
    },
    {
        name                :"Facebook clon" ,
    ...
    },
    {
        ...
        wil                 :"Like FACEBOOK-CLON, that was a project I developed shortly after learning HTML and CSS and the goal from the beginning was to develop a static and server less web page that would clone the home page of the famous Firefox browser."
    },
    {
    ...
    },
    {
        ...
        wil                 :"Again, a simple PyGame project, I did it in a couple of hours, I developed it from a simple idea I came up with, bringing to life a pretty nice graphical effect. It's worth noting that, although it seems extremely simple, this project led me to develop a great taste for graphical effects."
    },
    {
        name                :"Pagina Figo" ,
    ...
    },
    {
        ...
        wil                 :"In my time of developing simple video games using PyGame, I developed my own sprites for the animations using Paint, the windows program. I felt the need to program something to quickly test my sprites. For that I made this project, an easy, fast, flexible (and free) way to test my sprites."
    },
    {
        name                :"Weder" ,
