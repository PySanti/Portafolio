...
export function About(props){
    ...
    <section className="about-container">
        ...
        <p className="about-container__paraph">
            ...
            <a  href="https://elucabista.com/2022/06/09/qs-world-university-ranking-2023-la-ucab-sigue-siendo-la-mejor-universidad-privada-venezuela/"className="about-container__paraph__u">Universidad Catolica Andres Bello</a>, 
